...
def get_parameters(event):
    ...
    lambda_notification_events = _get_comma_delimited_list(event, 'LambdaNotificationEvents')
    return notification_bucket, lambda_function_arn, lambda_notification_events
...
def add_notification(notification_bucket, lambda_function_arn, lambda_notification_events):
            ...
            'LambdaFunctionConfigurations': [
                {
                    ...
                    'Events': lambda_notification_events
                }
            ]
        }
    )
